...
<div class="container-fluid" style="margin-top:10px">
    ...
    <div class="row">
        ...
        <div class="columns">
            <ul class="list-group">
              <img src="japan/picture/lemon.jpg" alt="" width="80%" height="100%">
              <a href="{{ url('/lemon') }}"> Lemon</a>
        
            </ul>
          </div>
          <div class="columns">
              <ul class="list-group">
                <img src="japan/picture/loser.jpg" alt="" width="50%" height="100%">
                 <a href="{{ url('/loser') }}"> loser</a>
            ...
            <div class="columns">
                    <ul class="list-group">
                      <img src="japan/picture/orion.jpg" alt="" width="80%" height="100%">
                       <a href="{{ url('/orion') }}"> Orion</a>
